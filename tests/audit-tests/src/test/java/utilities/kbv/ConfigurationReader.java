...
public class ConfigurationReader {
    ...
    public static String getAddressCRITestEnvironment() {
        String addressCRITestEnvironment = System.getenv("ADDRESS_CRI_TEST_ENVIRONMENT");
        if (addressCRITestEnvironment == null) {
            throw new IllegalArgumentException("Environment variable ADDRESS_CRI_TEST_ENVIRONMENT is not set");
        }
        return addressCRITestEnvironment;
    }
