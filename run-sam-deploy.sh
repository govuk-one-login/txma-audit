...
#sam build --template-file event-processing/event-processor-template.yml --config-file event-processing/config/samconfig-ep.toml --config-env "$environment"
#sam deploy --template-file event-processing/event-processor-template.yml --config-file event-processing/config/samconfig-ep.toml --config-env "$environment" --resolve-s3

#sam deploy --template-file audit/audit-template.yml --config-file audit/config/samconfig-audit.toml --config-env "$environment"
